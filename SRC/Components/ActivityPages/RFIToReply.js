...
export default class RFIToReply extends Component{
  constructor(props){
    super(props);
    this.state={
      rfi:{},
    ...
    render(){
        return(
          ...
          <View style={styles.headerContainer}>
            ...
            <Text style={styles.headerText}>RFI Id: 7</Text>
          </View>
          ...
          <Text style={styles.uploadButtonText}>Reply</Text>
        </TouchableOpacity>
