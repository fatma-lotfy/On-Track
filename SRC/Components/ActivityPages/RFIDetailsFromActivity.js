        ...
        return(
          ...
          <View style={styles.descriptionContainer}>
            ...
            >
              ...
              />
              <Text>{this.state.activity.name}</Text>
            </View>
          </View>
          <View style={styles.descriptionContainer}>
          ...
          <View style={styles.dateContainer}>
            ...
            <View style={{ flexDirection: "row" }}>
              ...
              />
              <Text>{new Date(this.state.rfi.dateCreated).toLocaleDateString()}</Text>
            </View>
          </View>
          <View style={styles.dateContainer}>
            ...
            <View style={{ flexDirection: "row" }}>
              ...
              />
              <Text>{new Date(this.state.rfi.dateNeededBy).toLocaleDateString()}</Text>
            </View>
          </View>
          <View style={styles.descriptionContainer}>
